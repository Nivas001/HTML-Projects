// Dummy data array
const patients = [
    { time: "10:30", name: "Abdul", age: 25, problem: "Bleeding gums", gender: "Male", patientId: 1, dob: "05 May 1999", extra_illness: false, on_medication: true, blood_transfusion: false, allergy: "None", blood_transfusion_date: "" },
...
function generateCardsBasedOnSelection() {
    ...
    if (selectedDate === 'yesterday') {
        ...
        patientLabel.textContent = 'Today\'s Appointments';
    }
...
function createCard(patient) {
    ...
    // if(patient.blood_transfusion){
    //     const bloodTransfusionDateRow = createTableRow('Blood Transfusion Date', patient.blood_transfusion_date);
    //     table.appendChild(bloodTransfusionDateRow);
    // }
