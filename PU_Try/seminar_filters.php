...
if (isset($_POST['features'])) {
    ...
    while ($hall = mysqli_fetch_assoc($result)) {
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 mb-4">
            <div class="card" onclick="location.href=\'room_details.php?hall_id=' . $hall['hall_id'] . '&type=seminar_hall\'">
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#bookingModal" data-roomid="' . $hall['hall_id'] . '" data-roomname="' . $hall['room_name'] . '" onclick="event.stopPropagation();">Book Now</button>
                        </div>
                    </div>
                </div>
            </div>
